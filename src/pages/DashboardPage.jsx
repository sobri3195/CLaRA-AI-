import { AlertCircle, Banknote, ClipboardCheck, FileStack, TrendingDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <StatCard title="Estimasi Potensi Penghematan" value={`Rp ${dashboardStats.estimatedSaving.toLocaleString('id-ID')}`} icon={TrendingDown} tone="teal" />
      </div>
